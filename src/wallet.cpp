...
// Nuaxes: total coins staked (non-spendable until maturity)
...
// Nuaxes: get current stake weight
...
// Nuaxes: check 'spent' consistency between wallet and txindex
// Nuaxes: fix wallet spent state according to txindex
...
// Nuaxes: disable transaction (only for coinstake)
