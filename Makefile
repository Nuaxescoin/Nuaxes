#############################################################################
# Makefile for building: Nuaxes-qt
# Generated by qmake (2.01a) (Qt 4.8.6) on: Wed Apr 12 23:00:17 2018
# Project:  Nuaxes-qt.pro
# Template: app
# Command: c:\Qt\4.8.6\bin\qmake.exe USE_QRCODE=1 USE_UPNP=1 -o Makefile Nuaxes-qt.pro
#############################################################################
...
Makefile: Nuaxes-qt.pro  ../Qt/4.8.6/mkspecs/default/qmake.conf ../Qt/4.8.6/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_QRCODE=1 USE_UPNP=1 -o Makefile Nuaxes-qt.pro
...
clean: release-clean debug-clean FORCE
	-$(DEL_FILE) C:/Nuaxes/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) C:/Nuaxes/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) $(MAKE)
	-$(DEL_FILE) clean
...
C:/Nuaxes/src/leveldb/libleveldb.a: FORCE
